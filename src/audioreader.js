/*!
	AudioReader version 1.0.0-beta
	(c) 2015-2016, 2024 epistemex
	MIT License
*/
 ...
 *         const aCtx = result.audioContext;          // get shared audio context
 ...
 * @static
 */
function AudioReader(input, audioCtx) {
  ...
  function parseChunks(actx, view, type, chunks) {
    ...
    let i, chunk, pos, cSize, aBuffer, channels, rate, bits,
      frame, frames, format, formats, time;
    let comp = '';
  ...
  function convert(actx, view, length, offset, channels, rate, bits, frames, lsb, comp) {
    ...
    const calls = [ dither ? get8Dlsb : get8, get16lsb, get24P, get32lsb,
